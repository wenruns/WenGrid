...
//        $header = $this->checkHtmlString($this->grid->getWenExporter()->setHeader());
        $header = $this->grid->getWenExporter()->setHeader();
//        $footer = $this->checkHtmlString($this->grid->getWenExporter()->setFooter());
        $footer = $this->grid->getWenExporter()->setFooter();
        ...
        $script = <<<SCRIPT
            ...
            function makeHead(){
                ...
                var head = {$head};
                var headerFunc = {$header};
                if (headerFunc) {
                    let str = headerFunc(data_{$this->key});
                    if (str) {
                        excelHtml_{$this->key} += checkString(str);
                    }
                }
            ...
            // 生成脚部
            function makeFooter(){
                var footerFunc = {$footer};
                if (footerFunc) {
                    let str = footerFunc(data_{$this->key});
                    if (str) {
                        excelHtml_{$this->key} += checkString(str);
                    }
                }
            ...
            function getData(event){
                ...
                // console.log(url, data, {$this->grid->getSelectedRowsName()}());
